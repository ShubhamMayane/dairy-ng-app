...
@Component({
  selector: 'app-faq-client-stories',
  imports: [RatingModule,CommonModule,FormsModule],
  templateUrl: './faq-client-stories.component.html',
  styleUrl: './faq-client-stories.component.css',
  schemas:[CUSTOM_ELEMENTS_SCHEMA ]
  
})
export class FaqClientStoriesComponent implements OnInit, OnDestroy {
